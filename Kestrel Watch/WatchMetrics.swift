...
enum WatchMetrics {
    ...
    static var current: Metrics {
        ...
        case CGSize(width: 208, height: 248): radius = 49   // 46mm  (Series 10/11) — measured; table lists 49
        case CGSize(width: 205, height: 251): radius = 54   // 49mm  (Ultra 1/2/3)
        ...
        switch size {
        case CGSize(width: 162, height: 197): imageMargin = 8; nameImageGap = 8   // 40mm  (SE 2/3, Series 6)
        default:
